...
Run `task tidy` to regenerate `go.sum`. Run `task fix` to rewrite source files. Do not edit these tooling-managed files by hand. See the root [Verifying your work](../../docs/agent/verification.md) guide for this rule.
