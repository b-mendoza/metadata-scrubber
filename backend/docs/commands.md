...
| `task lint` | Run `golangci-lint`, verify formatting, and run `task lint:analysis`. This command is read-only. |
| `task lint:analysis` | Run the custom backend analyzers. This command is read-only. |
