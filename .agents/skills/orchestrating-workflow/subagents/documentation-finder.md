...
3. Inline or code-adjacent documentation such as specs, typed interfaces, and docstrings
...
- Cap summary results at 5 documents unless the caller explicitly asks for broader coverage.
