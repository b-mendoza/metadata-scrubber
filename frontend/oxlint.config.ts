...
export default defineConfig({
  ...
  plugins: ["typescript", "node", "promise", "import", "react", "jsx-a11y"],
  jsPlugins: [
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        // `eslint-plugin-vitest` supports options for this rule (for example
        // `fixable`), but Oxc's `vitest/no-focused-tests` does not.
        // Keep it disabled here to avoid an invalid-rule-configuration error.
